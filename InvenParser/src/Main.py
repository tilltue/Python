...
def main():
    f = file('card.txt','w')
    f.write('{\n')
    codes = ['1117','68','257','932','242','299','511','1243','195','654','351','348','311','858','1074','854','584','605','915','186','404','1659','1401','1019','878','48','1221','801',
            '1014','1108','985','962','768','140','777','893','443','1241','397','338','526','365','1124','523','180','1657','75','1371','336','724','680','287','22','376','1147','430','512','971'
            ]
    f.write('\t"cards" : [\n')
    for code in codes:
        f.write('\t\t\t{')
